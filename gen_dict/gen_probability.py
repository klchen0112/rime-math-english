...
en_phrase_set = set()
en_word_set = set()
with open("probability.txt", "r") as src_file:
...
with open("../probability.extended/probability_zh.dict.yaml", "w") as dstZH:
    dstZH.write(
...
with open("../probability.extended/probability_en_phrase.dict.yaml", "w") as dstENPhrase:
    dstENPhrase.write(
        "---\nname: probability_en_phrase\nversion: \"2021.10.13\"\nsort: by_weight\nuse_preset_vocabulary: false\n...\n\n")
...
with open("../probability.extended/probability_en_word.dict.yaml", "w") as dstENWord:
    dstENWord.write(
